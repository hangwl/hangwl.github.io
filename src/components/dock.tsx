...
import { HomeIcon, NotebookPen, Backpack, FlaskConical } from "lucide-react";
...
const Icons = {
  resume: (props: IconProps) => <Backpack {...props} />,
...
const DATA = {
  ...
  contact: {
    social: {
      ...
      GitHub: {
        name: "GitHub",
        url: "https://github.com/hangwl/",
        icon: Icons.github,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/hang-wei-low-02782b158/",
        icon: Icons.linkedin,
      },
    },
  },
