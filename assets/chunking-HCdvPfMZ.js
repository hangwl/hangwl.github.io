import{j as e}from"./index-CtAT4ExP.js";const r={title:"Chunking"};function s(t){const n={blockquote:"blockquote",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Introduction"}),`
`,e.jsxs(n.p,{children:["Chunking is the process of breaking down documents into ",e.jsx(n.strong,{children:"smaller segments"}),"."]}),`
`,e.jsxs(n.p,{children:[`With a good chunking strategy, we can improve the overall retrieval quality of a RAG system.
Mainly, chunking can allows us to `,e.jsx(n.strong,{children:"more precisely represent"}),` a long document over multiple vectors instead of just a single compressed vector.
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Basic chunking"})," techniques focus on adjusting ",e.jsx(n.strong,{children:"chunk size"})," and ",e.jsx(n.strong,{children:"chunk overlap"}),`.
...
`,e.jsxs(n.p,{children:["Language based chunking uses ",e.jsx(n.strong,{children:"LLMs"}),` to chunk documents.
...
`,e.jsxs(n.p,{children:["This approach tries to make use of LLMs to ",e.jsx(n.strong,{children:"append additional context"}),` to each chunk.
The added context may `,e.jsx(n.strong,{children:"improve"})," the vectorization process and increase overall ",e.jsx(n.strong,{children:"search relevance"}),` scores.
...
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"/images/9ROHXfA1tQ.png",alt:"Context Aware Chunking"})})]})}function c(t={}){const{wrapper:n}=t.components||{};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{c as default,r as frontmatter};
