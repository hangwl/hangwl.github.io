import{j as e}from"./index-DXXDdCrE.js";const o={title:"Transformers",links:["cross-encoders"]};function r(t){const n={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",h4:"h4",img:"img",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Introduction"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.strong,{children:"Transformer"})," architecture was first proposed in the 2017 paper titled ",e.jsx(n.a,{href:"https://arxiv.org/abs/1706.03762",children:"Attention is All You Need"}),` by Google.
...
`,e.jsxs(n.p,{children:[`In the past, encoder-decoder architectures relied on mainly Recurrent Neural Networks (RNNs) to extract sequential information.
...
`,e.jsxs(n.p,{children:["Encoder-only models are designed for tasks that require deep ",e.jsx(n.strong,{children:"contextual understanding of the input sequence"}),` without generating an output sequence.
...
`]}),`
`,e.jsxs(n.p,{children:[`After stacking multiple encoder layers, the final contextualized embeddings can either be pooled into a single vector (e.g., mean pooling)
or represented by a special token (e.g., `,e.jsx(n.code,{children:"[CLS]"}),"), depending on the model’s design and task."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Modern embedding models such as ",e.jsx(n.code,{children:"gemini-embedding-001"}),` leverage attention mechanisms to produce high-quality vector representations,
enabling State-of-the-Art performance on semantic similarity and retrieval tasks.`]}),`
`]}),`
`,e.jsx(n.h3,{children:"Encoder-Decoder Models"}),`
`,e.jsxs(n.p,{children:[`Encoder-decoder models are designed for tasks that require transformation from one sequence to another.
...
`,e.jsx(n.h4,{children:"Encoder Block"}),`
`,e.jsxs(n.p,{children:[`The encoder block first processes the entire input sequence and builds a rich, contextualized understanding of it.
It takes the token and positional embeddings, processes them through its `,e.jsx(n.strong,{children:"multi-head self-attention layers"}),` to capture the bi-directional context,
...
`,e.jsx(n.h4,{children:"Decoder Block"}),`
...
`]}),`
`,e.jsx(n.p,{children:`After passing through multiple stacked decoder layers, the final output is projected through a linear layer (the prediction head)
and softmax to produce a probability distribution over the vocabulary, from which the next token is selected.`}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["State-of-the-art sequence-to-sequence models such as ",e.jsx(n.code,{children:"T5"})," (Text-to-Text Transfer Transformer) and ",e.jsx(n.code,{children:"mT5"}),` (its multilingual variant)
...
`]}),`
`,e.jsx(n.h3,{children:"Decoder-Only Models"}),`
`,e.jsx(n.p,{children:`Decoder-only models are designed for tasks that require generating text in an autoregressive fashion.
...
`,e.jsx(n.h3,{children:"Add & Norm"}),`
`,e.jsxs(n.p,{children:["Add & Norm refers to ",e.jsx(n.strong,{children:"Residual Connection followed by Layer Normalization"}),`.
Together, they ensure that each layer can always fall back on its input (residual connection) while keeping activations stable and trainable (normalization).`]})]})}function i(t={}){const{wrapper:n}=t.components||{};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{i as default,o as frontmatter};
