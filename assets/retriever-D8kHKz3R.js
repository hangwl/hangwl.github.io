import{j as e}from"./index-895OKoX5.js";const i=[{id:"introduction",title:"Introduction",level:2},{id:"document-relevance",title:"Document Relevance",level:2},{id:"search-techniques",title:"Search Techniques",level:2},{id:"keyword-search",title:"Keyword Search",level:3},{id:"semantic-search",title:"Semantic Search",level:3},{id:"metadata-filtering",title:"Metadata Filtering",level:3}],s={title:"Retriever",links:["keyword-search","semantic-search","retriever-evaluation-metrics","vector-databases","query-parsing","cross-encoders","reranking"],hide:!1};function r(n){const t={a:"a",blockquote:"blockquote",h2:"h2",h3:"h3",img:"img",p:"p",strong:"strong",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{id:"introduction",children:"Introduction"}),`
`,e.jsx(t.p,{children:`The purpose of a retriever in the context of RAG systems is to provide useful information to LLMs so that they can generate better responses.\r
...
`]}),`
`,e.jsx(t.h2,{id:"document-relevance",children:"Document Relevance"}),`
`,e.jsx(t.p,{children:`Ideally, only the most relevant documents should be retrieved as opposed to overloading an LLMs context window by stuffing all available documents to it.\r
...
`]}),`
`,e.jsx(t.h2,{id:"search-techniques",children:"Search Techniques"}),`
`,e.jsx(t.p,{children:`Most modern retrievers make use of both keyword search and semantic search in hybrid search.\r
...
`,e.jsx(t.h3,{id:"keyword-search",children:"Keyword Search"}),`
...
`,e.jsx(t.h3,{id:"semantic-search",children:"Semantic Search"}),`
...
`,e.jsx(t.h3,{id:"metadata-filtering",children:"Metadata Filtering"}),`
...
`]})]})}function o(n={}){const{wrapper:t}=n.components||{};return t?e.jsx(t,{...n,children:e.jsx(r,{...n})}):r(n)}export{o as default,s as frontmatter,i as toc};
