import{j as e}from"./index-DXXDdCrE.js";const r={title:"Delta Lake"};function a(n){const t={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",h4:"h4",p:"p",strong:"strong",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{children:"Introduction"}),`
`,e.jsxs(t.p,{children:[e.jsx(t.a,{href:"https://delta.io/",children:"Delta Lake"}),` is a storage layer framework for lakehouse architectures commonly built on Amazon S3.
...
`,e.jsxs(t.p,{children:[`In a traditional data lake, a write operation that fails midway can leave the data in a corrupt or inconsistent state.
Delta Lake's transaction logs ensures that every write operation is `,e.jsx(t.strong,{children:"atomic"}),", meaning that it ",e.jsx(t.strong,{children:"either fully succeeds or fully fails"}),`.
...
`,e.jsxs(t.p,{children:["In a Delta Lake, queries are guaranteed to always see a ",e.jsx(t.strong,{children:"consistent"}),", ",e.jsx(t.strong,{children:"unchanging snapshot"}),` of the data, even if other transactions are writing to the same table at the same time.
This happens because when a query starts, it `,e.jsx(t.strong,{children:"binds"})," the latest committed ",e.jsx(t.strong,{children:"table version"}),` at that moment.
...
`,e.jsx(t.p,{children:`When a writer is ready to commit a transaction, Delta Lake checks the transaction log for new commits.
...
`,e.jsxs(t.p,{children:[`Data Durability is generally managed by cloud storage service providers.
...
`,e.jsxs(t.blockquote,{children:[`
`,e.jsx(t.p,{children:`Data is replicated automatically across multiple Availability Zones (AZs) within a region.
