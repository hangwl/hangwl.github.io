import{j as e}from"./index-895OKoX5.js";const s=[{id:"introduction",title:"Introduction",level:2},{id:"requirements",title:"Requirements",level:2},{id:"evaluation-metrics",title:"Evaluation Metrics",level:2},{id:"top-k",title:"Top-K",level:3},{id:"recall-at-k-recallk",title:"Recall at K (Recall@K)",level:3},{id:"mean-average-precision-at-k-mapk",title:"Mean Average Precision at K (MAP@K)",level:3},{id:"mean-reciprocal-rank-mrr",title:"Mean Reciprocal Rank (MRR)",level:3}],o={title:"Retriever Evaluation Metrics"};function n(t){const r={blockquote:"blockquote",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(r.h2,{id:"introduction",children:"Introduction"}),`
...
`,e.jsx(r.h2,{id:"evaluation-metrics",children:"Evaluation Metrics"}),`
...
`]}),`
`,e.jsx(r.h3,{id:"top-k",children:"Top-K"}),`
...
`,e.jsx(r.h3,{id:"recall-at-k-recallk",children:"Recall at K (Recall@K)"}),`
...
`]}),`
`,e.jsx(r.h3,{id:"mean-average-precision-at-k-mapk",children:"Mean Average Precision at K (MAP@K)"}),`
...
`,e.jsx(r.h3,{id:"mean-reciprocal-rank-mrr",children:"Mean Reciprocal Rank (MRR)"}),`
...
`,e.jsx(r.p,{children:e.jsx(r.img,{src:"/images/0nA49Uw3hB.png",alt:"Mean Reciprocal Rank 2"})})]})}function a(t={}){const{wrapper:r}=t.components||{};return r?e.jsx(r,{...t,children:e.jsx(n,{...t})}):n(t)}export{a as default,o as frontmatter,s as toc};
