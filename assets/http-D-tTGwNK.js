import{j as s}from"./index-CtAT4ExP.js";const t={title:"HTTP",links:["https","http-vs-https","rest-api"]};function n(i){const e={a:"a",code:"code",figure:"figure",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i.components};return s.jsxs(s.Fragment,{children:[s.jsx(e.h2,{children:"Introduction"}),`
...
`,s.jsx(e.h2,{children:"How HTTP Works"}),`
...
`]}),`
`,s.jsx(e.h2,{children:"HTTP Request"}),`
...
`]}),`
`,s.jsx(e.h2,{children:"HTTP Response"}),`
...
`]}),`
`,s.jsx(e.h2,{children:"HTTP Methods"}),`
...
`,s.jsx(e.h2,{children:"Status Codes"}),`
`,s.jsx(e.h3,{children:"2xx Success"}),`
`,s.jsxs(e.ul,{children:[`
...
`]}),`
`,s.jsx(e.h3,{children:"3xx Redirection"}),`
`,s.jsxs(e.ul,{children:[`
...
`]}),`
`,s.jsx(e.h3,{children:"4xx Client Errors"}),`
`,s.jsxs(e.ul,{children:[`
...
`]}),`
`,s.jsx(e.h3,{children:"5xx Server Errors"}),`
`,s.jsxs(e.ul,{children:[`
...
`]}),`
`,s.jsx(e.h2,{children:"HTTP Versions"}),`
...
`]}),`
`,s.jsxs(e.p,{children:["For secure communication, always use ",s.jsx(e.a,{href:"/notes/https",children:"HTTPS"})," in production."]})]})}function l(i={}){const{wrapper:e}=i.components||{};return e?s.jsx(e,{...i,children:s.jsx(n,{...i})}):n(i)}export{l as default,t as frontmatter};
