import{j as e}from"./index-CtAT4ExP.js";const t={title:"Web Workers"};function r(s){const n={a:"a",code:"code",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Introduction"}),`
...
`,e.jsx(n.h2,{children:"Why Use Web Workers?"}),`
...
`]}),`
`,e.jsx(n.h2,{children:"How Web Workers Work"}),`
...
`]}),`
`,e.jsx(n.h2,{children:"Example: Web Workers in Action"}),`
...
`]}),`
`,e.jsx(n.p,{children:"The worker handles all simulation logic, state management, and calculations, while the main thread focuses on rendering and user interactions."})]})}function o(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}export{o as default,t as frontmatter};
