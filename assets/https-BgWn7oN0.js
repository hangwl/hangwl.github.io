import{j as i}from"./index-CtAT4ExP.js";const h={title:"HTTPS",links:["http","http-vs-https","ssl-tls","ssl-certificates"]};function n(e){const s={a:"a",code:"code",figure:"figure",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...e.components};return i.jsxs(i.Fragment,{children:[i.jsx(s.h2,{children:"Introduction"}),`
...
`,i.jsx(s.h2,{children:"How HTTPS Works"}),`
...
`,i.jsx(s.h2,{children:"Security Benefits"}),`
`,i.jsx(s.h3,{children:"Encryption"}),`
...
`]}),`
`,i.jsx(s.h3,{children:"Authentication"}),`
...
`]}),`
`,i.jsx(s.h3,{children:"Data Integrity"}),`
...
`]}),`
`,i.jsx(s.h2,{children:"HTTPS in Practice"}),`
`,i.jsx(s.h3,{children:"Browser Indicators"}),`
...
`]}),`
`,i.jsx(s.h3,{children:"Required For"}),`
...
`]}),`
`,i.jsx(s.h2,{children:"Server Configuration"}),`
`,i.jsx(s.h3,{children:"Nginx Example"}),`
...
`,i.jsx(s.span,{"data-line":"",children:i.jsx(s.span,{style:{"--shiki-dark":"#E6EDF3","--shiki-light":"#D4D4D4"},children:"}"})})]})})}),`
`,i.jsx(s.h3,{children:"Apache Example"}),`
...
`,i.jsxs(s.span,{"data-line":"",children:[i.jsx(s.span,{style:{"--shiki-dark":"#E6EDF3","--shiki-light":"#808080"},children:"</"}),i.jsx(s.span,{style:{"--shiki-dark":"#79C0FF","--shiki-light":"#D4D4D4"},children:"VirtualHost"}),i.jsx(s.span,{style:{"--shiki-dark":"#E6EDF3","--shiki-light":"#808080"},children:">"})]})]})})}),`
`,i.jsx(s.h2,{children:"Security Headers"}),`
...
`,i.jsx(s.h2,{children:"Mixed Content"}),`
...
`,i.jsx(s.h2,{children:"Migration Steps"}),`
`,i.jsxs(s.ol,{children:[`
...
`]}),`
`,i.jsx(s.h3,{children:"Let's Encrypt"}),`
...
`,i.jsx(s.h2,{children:"Performance"}),`
...
`,i.jsx(s.h2,{children:"Best Practices"}),`
`,i.jsxs(s.ul,{children:[`
...
`]}),`
`,i.jsx(s.h2,{children:"Common Issues"}),`
`,i.jsxs(s.ul,{children:[`
...
`]}),`
`,i.jsxs(s.p,{children:["For detailed information on SSL/TLS, see ",i.jsx(s.a,{href:"/notes/ssl-tls",children:"SSL/TLS"})," and ",i.jsx(s.a,{href:"/notes/ssl-certificates",children:"SSL Certificates"}),"."]})]})}function r(e={}){const{wrapper:s}=e.components||{};return s?i.jsx(s,{...e,children:i.jsx(n,{...e})}):n(e)}export{r as default,h as frontmatter};
