import{j as e}from"./index-CtAT4ExP.js";const i={title:"Reranking"};function s(r){const n={h2:"h2",img:"img",p:"p",strong:"strong",...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Introduction"}),`
...
`,e.jsxs(n.p,{children:["Typically, rerankers have a ",e.jsx(n.strong,{children:"cross-encoder"}),` architecture that may increase the latency of the system.
However, they can significantly improve the ranking quality of the retrieved documents.`]}),`
`,e.jsxs(n.p,{children:["Alternatively, ",e.jsx(n.strong,{children:"LLMs"}),` can also be used as a reranker.
