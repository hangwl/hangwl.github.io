import{j as e}from"./index-BY1L9Kpq.js";const s=[{id:"introduction",title:"Introduction",level:2},{id:"contextualized-late-interaction-over-bert-colbert",title:"Contextualized Late Interaction Over BERT (ColBERT)",level:2}],i={title:"Cross-Encoders",links:["reranking"]};function r(t){const n={blockquote:"blockquote",h2:"h2",img:"img",p:"p",strong:"strong",...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{id:"introduction",children:"Introduction"}),`
...
`,e.jsx(n.h2,{id:"contextualized-late-interaction-over-bert-colbert",children:"Contextualized Late Interaction Over BERT (ColBERT)"}),`
...
`]})]})}function a(t={}){const{wrapper:n}=t.components||{};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{a as default,i as frontmatter,s as toc};
