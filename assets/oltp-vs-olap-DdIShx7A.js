import{j as e}from"./index-CtAT4ExP.js";const i={title:"OLTP vs OLAP"};function t(s){const n={a:"a",blockquote:"blockquote",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Introduction"}),`
...
`,e.jsx(n.p,{children:`The addition of an intermediate data lake staging layer is often used as a cost-effective strategy to decouple OLTP and OLAP systems.
...
`,e.jsxs(n.p,{children:["OLTP systems are write-heavy and its data models are ",e.jsx(n.strong,{children:"normalized"}),` to minimize data redundancy and to optimize write operations.
...
`,e.jsxs(n.p,{children:["OLAP systems act as ",e.jsx(n.strong,{children:"data warehouses"}),` for organizations that depend on its data for analysis and reporting.
Within them, `,e.jsx(n.strong,{children:"data marts"})," can be built to serve different departments."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsx(n.p,{children:`A data mart is a strategic data layer built on top of OLAP systems (typically data warehouses) to serve specific business domain needs.
...
`,e.jsxs(n.p,{children:["A Star Schema is used to denormalize business data into ",e.jsx(n.strong,{children:"dimensions"})," (like time and product) and ",e.jsx(n.strong,{children:"facts"}),` (like transactions in amounts and quantities).
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsx(n.p,{children:`To design a star schema data model, we always want to start by thinking about the "grain" of the data.
...
`]}),`
`,e.jsx(n.h2,{children:"Table Optimizations (READS)"}),`
...
`]}),`
`,e.jsx(n.h3,{children:"Partitioning"}),`
`,e.jsxs(n.ul,{children:[`
...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsx(n.p,{children:`Note however that partitioning an existing table can be resource-intensive if the table is large and contains billions of rows.
This is because partitioning requires a full scan of the table to create the partitions.`}),`
`]}),`
`,e.jsx(n.h3,{children:"Materialized Views"}),`
`,e.jsxs(n.ul,{children:[`
...
`]})]})}function r(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{r as default,i as frontmatter};
