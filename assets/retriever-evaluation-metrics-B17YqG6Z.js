import{j as e}from"./index-1jHvJRAh.js";const o={title:"Retriever Evaluation Metrics"};function n(t){const r={blockquote:"blockquote",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(r.h2,{children:"Introduction"}),`
`,e.jsxs(r.p,{children:[`The primary goal of establishing metrics for information retrievers is to optimize the quality of search results.
...
`,e.jsxs(r.p,{children:["To evaluate the performance of a retriever, we need to first prepare a collection of ",e.jsx(r.strong,{children:"ground truths"}),`.
...
`,e.jsxs(r.p,{children:[`The goal of establishing evaluation metrics is to optimize the retriever's ability to retrieve relevant documents.
...
`,e.jsx(r.p,{children:`When optimizing a retriever, we normally need to consider tradeoffs between precision and recall.
...
`,e.jsxs(r.p,{children:["Typically in RAG systems, the ",e.jsx(r.strong,{children:"top-k highest ranked documents"})," are retrieved for evaluation across ",e.jsx(r.strong,{children:"different values of k"}),`.
...
`,e.jsxs(r.blockquote,{children:[`
`,e.jsx(r.p,{children:`However it does not account for the ranking of retrieved documents, and assumes a complete collection of ground truths.
...
`,e.jsxs(r.p,{children:["MRR measures the ",e.jsx(r.strong,{children:"rank of the first relevant document"}),` in the returned list of retrieved documents, averaged across various prompts.
It generally measures how well the retriever performs at the top of ranked documents.`]}),`
`,e.jsxs(r.blockquote,{children:[`
`,e.jsx(r.p,{children:`A poor MRR score is a strong signal that the system isn't effectively ranking the correct documents at the top of its results.
