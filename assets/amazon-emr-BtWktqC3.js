import{j as e}from"./index-BKgolIEe.js";const a=[{id:"what-is-amazon-emr",title:"What is Amazon EMR?",level:2},{id:"benefits-of-using-amazon-emr",title:"Benefits of using Amazon EMR",level:2},{id:"cost-savings",title:"Cost-Savings",level:3},{id:"flexibility-and-scalability",title:"Flexibility and Scalability",level:3}],l={title:"Amazon EMR",links:["amazon-s3","delta-lake"]};function t(s){const n={a:"a",blockquote:"blockquote",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{id:"what-is-amazon-emr",children:"What is Amazon EMR?"}),`
...
`,e.jsx(n.h2,{id:"benefits-of-using-amazon-emr",children:"Benefits of using Amazon EMR"}),`
...
`,e.jsx(n.h3,{id:"cost-savings",children:"Cost-Savings"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"No need to setup on-premise resources"}),`
`,e.jsx(n.li,{children:"Pay-per-use pricing model"}),`
`]}),`
`,e.jsx(n.h3,{id:"flexibility-and-scalability",children:"Flexibility and Scalability"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Clusters can be automatically scaled up or down depending on computing needs"}),`
`,e.jsx(n.li,{children:`The EMR File System (EMRFS) allows Amazon S3 to be used as a data layer for applications running on the cluster.\r
This means that compute and storage are separated, but the data can still be persisted.\r
This also means they can be scaled independently.`}),`
`]})]})}function o(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{o as default,l as frontmatter,a as toc};
