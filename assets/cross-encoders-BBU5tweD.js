import{j as e}from"./index-DXXDdCrE.js";const o={title:"Cross-Encoders",links:["reranking"]};function t(r){const n={blockquote:"blockquote",h2:"h2",img:"img",p:"p",strong:"strong",...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Introduction"}),`
...
`,e.jsxs(n.p,{children:["To further improve search results, ",e.jsx(n.strong,{children:"Cross-Encoder"}),` models can be used instead.
...
`,e.jsx(n.p,{children:`When a knowledge base contains large number of documents, finding the relevancy score for every concatenated prompt and document is not a scalable solution.
...
`,e.jsxs(n.p,{children:[`Instead of generating one vector for each prompt and document, every token is vectorized.
Each prompt vector tries to find its most similar document vector.
The highest relevancy scores for each prompt-document token pair are summed to form the `,e.jsx(n.strong,{children:"MaxSim"}),` score for a document.
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsx(n.p,{children:`While ColBERT is designed to be scalable and reasonably fast, note that it requires significantly more storage for every vectorized token.
