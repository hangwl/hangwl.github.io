import{j as e}from"./index-DOxJc1g0.js";const r={title:"Amazon S3"};function a(s){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"What is Amazon S3?"}),`
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"https://docs.aws.amazon.com/AmazonS3/latest/userguide/Welcome.html",children:"Amazon Simple Storage Service (Amazon S3)"}),` is an object storage service similar to Google Cloud Storage.\r
...
`,e.jsx(n.p,{children:`As a Representational State Transfer (REST) API, it utilizes HTTP requests (GET, PUT, POST, DELETE) to perform operations on S3 resources,\r
making it a stateless protocol where the server does not retain client session information.`}),`
`]}),`
`,e.jsxs(n.p,{children:["Developers can make use of available ",e.jsx(n.strong,{children:"AWS SDK"})," libraries (",e.jsx(n.strong,{children:"Boto3"}),` for Python) to build applications more easily without having to deal\r
