import{j as e}from"./index-DmIt1YIB.js";const r=[{id:"introduction",title:"Introduction",level:2},{id:"advanced-chunking",title:"Advanced Chunking",level:2},{id:"semantic-chunking",title:"Semantic Chunking",level:3},{id:"language-based-chunking",title:"Language Based Chunking",level:3},{id:"context-aware-chunking",title:"Context-Aware Chunking",level:3}],c={title:"Chunking"};function s(t){const n={blockquote:"blockquote",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{id:"introduction",children:"Introduction"}),`
...
`,e.jsx(n.h2,{id:"advanced-chunking",children:"Advanced Chunking"}),`
...
`,e.jsx(n.h3,{id:"semantic-chunking",children:"Semantic Chunking"}),`
...
`,e.jsx(n.h3,{id:"language-based-chunking",children:"Language Based Chunking"}),`
...
`,e.jsx(n.h3,{id:"context-aware-chunking",children:"Context-Aware Chunking"}),`
...
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"/images/9ROHXfA1tQ.png",alt:"Context Aware Chunking"})})]})}function a(t={}){const{wrapper:n}=t.components||{};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{a as default,c as frontmatter,r as toc};
