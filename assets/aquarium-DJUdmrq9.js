import{j as e}from"./index-1jHvJRAh.js";const n={title:"Aquarium",description:"A community-driven platform aimed at addressing data scarcity and increasing language representation within Southeast Asia. It features an assistive chatbot focused on increasing data accessibility to the public.",date:"2025-06-05",tags:["Next.js","Python","PostgreSQL","FastAPI","LangGraph"],image:"/images/aquarium.svg",website:"https://aquarium.sea-lion.ai/",status:"completed",featured:!0,order:1};function a(t){const i={a:"a",blockquote:"blockquote",code:"code",figcaption:"figcaption",figure:"figure",h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.h1,{children:"Introduction"}),`
`,e.jsx(i.p,{children:`Aquarium is a platform that was developed to address challenges related to the accessibility of language datasets specifically within Southeast Asia.
...
`,e.jsx(i.p,{children:`As an AI Apprentice, I was given the opportunity to work on the beta version of the Aquarium project for a period of 7 months alongside 2 mentors and 2 other apprentices.
...
`,e.jsx(i.p,{children:`The initial scope of the project presented to the apprentices was truthfully vague.
...
`,e.jsxs(i.p,{children:["To get things started, we were tasked to explore and analyze the data in the ",e.jsx(i.a,{href:"https://seacrowd.github.io/seacrowd-catalogue/",children:"SEACrowd Catalogue"}),`.
The public spreadsheet contains a collection of dataset metadata contributed by individuals from the `,e.jsx(i.a,{href:"https://seacrowd.github.io/",children:"SEACrowd community"}),`.
...
`,e.jsxs(i.p,{children:["In ",e.jsx(i.a,{href:"https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html",children:"LangChain"}),`, the Document class can be used to store a piece of text and associated its metadata.
...
`,e.jsx(i.span,{"data-line":"",children:e.jsx(i.span,{style:{"--shiki-dark":"#E6EDF3","--shiki-light":"#D4D4D4"},children:")"})})]})})]}),`
`,e.jsx(i.p,{children:`While this document model is potentially sufficient to support a chatbot that is capable of hybrid search, its design may be too simplistic and difficult to scale.
...
`,e.jsx(i.p,{children:`Agentic workflows enable the automation of tasks that were previously impossible.
...
`,e.jsx(i.p,{children:`However in LangGraph, memory can be shared between agent invocations via persistent graph states.
...
`,e.jsxs(i.p,{children:["The ",e.jsx(i.a,{href:"https://arxiv.org/abs/2210.03629",children:"Reason and Act (ReAct)"}),` framework is a popular general purpose agent architecture that leverages
the ability of LLMs to `,e.jsx(i.a,{href:"https://langchain-ai.github.io/langgraph/concepts/agentic_concepts/#planning",children:"plan"}),", use ",e.jsx(i.a,{href:"https://langchain-ai.github.io/langgraph/concepts/agentic_concepts/#tool-calling",children:"tools"}),`, and act on observations to achieve a certain goal.
...
`,e.jsx(i.p,{children:`The main requirement of the Aquarium chatbot is that it should be able to match a user's query to the most relevant dataset available.
...
`,e.jsx(i.p,{children:`The orchestrator agent is the main agent that is responsible for orchestrating the entire chatbot workflow as well as supervising and delegating tasks to other agents.
...
`,e.jsx(i.p,{children:`The translation tool is essential to ensure that user queries are first standardized to English.
...
`,e.jsx(i.p,{children:`If a user's query is too sparse or ambiguous, the orchestrator agent can decide to call the query expander tool to generate a more detailed query that improves retrieval recall performance.
...
`,e.jsxs(i.p,{children:[`After initial query preprocessing, the retrieval agent should be invoked if a data retrieval action is needed.
...
`,e.jsx(i.p,{children:`The purpose of the query embedder tool is to convert an input query into a vector embedding that can be used to perform vector search.
...
`,e.jsx(i.p,{children:`The Text-to-SQL tool can be used to convert natural language queries into SQL queries aligned with the schema of the database.
...
`,e.jsxs(i.blockquote,{children:[`
`,e.jsx(i.p,{children:`It is important to note that presently, the performance of Text-to-SQL tools fail to meet expectations when dealing with complex databases.
...
`,e.jsxs(i.blockquote,{children:[`
`,e.jsx(i.p,{children:`For a small database, a reranker tool may not be necessary.
...
`,e.jsxs(i.p,{children:[`After sufficient information is retrieved via the retrieval agent, and the orchestrator agent decides that sufficient context has been acquired,
the response generation agent should be invoked to generate an appropriate response to the initial user's query.
This may necessitate calling the `,e.jsx(i.code,{children:"translation tool"}),` once more to translate the response back to the user's original language,
