import{j as e}from"./index-DXXDdCrE.js";const o={title:"Vector Databases",links:["approximate-nearest-neighbors","chunking"]};function r(t){const n={h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Introduction"}),`
`,e.jsxs(n.p,{children:["Vector databases are databases ",e.jsx(n.strong,{children:"optimized to store and search through huge quantities of high-dimensional vector data"}),`.
